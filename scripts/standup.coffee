...
#   hubot create standup hh:mm [message] - Creates a standup at hh:mm every weekday for this room
#   hubot create standup hh:mm UTC+2 [message] - Creates a standup at hh:mm every weekday for this room (relative to UTC)
